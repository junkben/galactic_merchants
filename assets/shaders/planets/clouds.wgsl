...
struct LandMassCloudMaterialConfig {
    pixels: f32,
    cloud_cover: f32,
...
struct LandMassCloudMaterialColors {
    base: vec4<f32>,
    outline: vec4<f32>,
...
@group(2) @binding(0) var<uniform> info: LandMassCloudMaterialConfig;
